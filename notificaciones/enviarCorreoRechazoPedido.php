...
function enviarCorreoRechazoPedido(
    $paraCorreo,
    $nombreUsuario,
    $fechaSolicitud,
    $procesoSolicitante,
    ...
    try {
        ...
        // Bloque observación
        $htmlObservacion = '';
        if (!empty($observacion_diligenciado)) {
            $htmlObservacion = '
                <div style="margin-top: 15px;">
                    <div class="detail-label">Motivo del rechazo:</div>
                    <div class="observacion">' . htmlspecialchars($observacion_diligenciado) . '</div>
                </div>';
        }

        // Contenido del correo
        $mail->isHTML(true);
        $mail->Subject = '❌ Pedido Rechazado ' . ($consecutivo ? "#$consecutivo" : '');
...
<style>
    ...
    .header { background: linear-gradient(135deg, #b91c1c, #7f1d1d); color: white; padding: 30px; text-align: center; position: relative; }
...
<div class="container">
    ...
    <div class="content">
        ...
        <p>El siguiente pedido ha sido rechazado:</p>
        <div class="card">
