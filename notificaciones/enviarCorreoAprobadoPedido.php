...
function enviarCorreoAprobacionPedido(
    $paraCorreo,
    $nombreUsuario,
    $fechaSolicitud,
    $procesoSolicitante,
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = '✅ Pedido Aprobado ' . ($consecutivo ? "#$consecutivo" : '');
...
<style>
    ...
    .header { background: linear-gradient(135deg, #16a34a, #15803d); color: white; padding: 30px; text-align: center; position: relative; }
...
<div class="container">
    ...
    <div class="content">
        ...
        <p>El siguiente pedido ha sido aprobado:</p>
        <div class="card">
